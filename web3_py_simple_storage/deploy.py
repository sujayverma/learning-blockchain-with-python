...
w3 = Web3(Web3.HTTPProvider(
    "https://goerli.infura.io/v3/93004f82f2e047f790afea769e7ee86f"))
# chain_id = 1337
chain_id = 5
# my_address = "0x90F8bf6A479f320ead074411a4B0e7944Ea8c9C1"
my_address = "0x9a2C3A404B6e10d477d310854d20bCd9970acAC7"
load_dotenv()
private_key = os.getenv("PRIVATE_KEY")

print("Build a Contract...")
...
print("Sign a Contract")

# Send this signed tranaction.
tx_hash = w3.eth.send_raw_transaction(signed_txn.rawTransaction)
tx_receipt = w3.eth.wait_for_transaction_receipt(tx_hash)
print("Send and Deploy a Contract")
...
print("Make state change to contract.")
print(simple_storage.functions.retrive().call())
